...
// <image class=${styles.fileImgShow}  src=${fileImgShow}></image>

// import fileImgShow from '@/assets/file.png'
...
F.prototype = Parent.prototype;  // 将父类的原型作为实例的原型
...
// Son.prototype.name='xxp'

// const son=new Son()
// console.log(son.name); // son
// console.log(son.year(12)); // 12
// console.log(son.sex('man')); // man
...
console.log(son.name); // son
console.log(son.year(12)); // 12
console.log(son.sex('man')); // 报错 Uncaught TypeError: son.sex is not a function
...
var name = "windowsName";
    ...
    //  call 的原生实现 接受参数为依次传入 // 在非严格模式下，第一个参数传入null或undefined，会指向全局变量，也就是window。
    Function.prototype.call=function(context){
      var context=context||window
       context.fn=this
       var args=[]

       for(let i=1;i<arguments.length;i++){ // 从第一个参数开始
