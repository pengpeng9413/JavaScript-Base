...
// 下面我们来看看到底什么是调用栈和调用位置：
    ...
    foo();//2
      ...
      */
      ...
      //  我又回来了，我们接着继续写this,没办法，this真的太重要了

      /**
       * 之前我们确定了5中规则，那么规则之间有时候会遇到一个情景适用于多个规则的情况，那我们就得给它排个有限顺序
       * 这里限于篇幅，我们只讲结果
       */
      ...
      /**
       * 弦外之音，在阅读你不知道的js中，我发现了一个比较好玩的东西，
       * 1. 函数柯里化   
       * 2.  Object.create(null)  创建一个空的非委托的对象，比{}还空的对象
       * 然后贴出两段代码的例子，后续有时间再来继续挖
       */
